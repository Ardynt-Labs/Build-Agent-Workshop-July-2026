...
<figure><img src="assets/lab6-create-codespace.png" alt="GitHub repository page with the Code dropdown open on the Codespaces tab, showing &quot;Create codespace on main&quot;"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-codespace-vscode-loaded.png" alt="VS Code loaded in the Codespace, showing the repository's README.md and an open terminal"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-terminal-type-bash.png" alt="Terminal after opening, with &quot;bash&quot; typed and ready to run"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-clipboard-permission-popup.png" alt="Browser clipboard-permission popup for the Codespace, with Allow highlighted"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-notes-app-example.png" alt="Example note-taking doc with the instance URL, credentials, app sys_id, and the now-sdk commands filled in — the recommended way to prep values before pasting into the terminal"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-auth-type-basic.png" alt="now-sdk auth prompt: selecting &quot;basic&quot; as the authentication type"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

<figure><img src="assets/lab6-auth-alias-team.png" alt="now-sdk auth prompt: entering &quot;team&quot; as the alias"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

<figure><img src="assets/lab6-auth-username-password.png" alt="now-sdk auth prompt: entering the username and masked password"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

<figure><img src="assets/lab6-auth-success.png" alt="now-sdk auth completing successfully, with credentials stored under alias 'team'"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-init-npm-package-name.png" alt="now-sdk init prompting for the NPM package name, answered with &quot;team-app&quot;"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/lab6-transform-complete.png" alt="now-sdk transform finishing with &quot;Transform completed successfully&quot;"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
...
<figure><img src="assets/claude-code-setup-theme.png" alt="Claude Code's first setup screen: choosing a terminal text style/theme"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

Select Option 1 and hit Enter:

<figure><img src="assets/claude-code-setup-api-key.png" alt="Claude Code detecting the pre-wired API key and asking whether to use it — select option 1, Yes"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

Hit Enter:

<figure><img src="assets/claude-code-setup-security-notes.png" alt="Claude Code's security notes screen — press Enter to continue"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

Hit Enter:

<figure><img src="assets/claude-code-setup-terminal-settings.png" alt="Claude Code asking whether to use recommended terminal settings — press Enter to accept"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

Hit Enter (Codespaces do not store anything on your machine):

<figure><img src="assets/claude-code-setup-trust-folder.png" alt="Claude Code asking to trust the workspace folder — press Enter to accept (Codespaces don't persist anything locally)"><figcaption><p>Click on image to zoom in</p></figcaption></figure>

You are in.

<figure><img src="assets/claude-code-launched.png" alt="Claude Code launched and ready, showing the model (Opus 4.8) and workspace"><figcaption><p>Click on image to zoom in</p></figcaption></figure>
