...
![Reviewing Claude Code's clarifying-question answers for the new Now Assist skill before it proceeds](assets/lab8-skill-review-answers.png)
...
![Claude Code's build/deploy summary for Lab 8, with the manual verification steps to check the triage control](assets/lab8-build-deploy-verify-steps.png)
